                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="user_list-action">
                                        <a onclick="return confirm('Bạn có chắc chắn muốn xóa loại hàng này không?') ? window.location.href = '<?=$ADMIN_URL?>/loai-hang/?btn_delete&id=<?=$item['id'];?>' : false;" class="content__table-action danger">
                                            <i class="fas fa-trash"></i>
                                        </a>
                                        <a href="<?=$ADMIN_URL?>/loai-hang/?btn_edit&ma_loai=<?=$item['id'];?>" class="content__table-action info">
