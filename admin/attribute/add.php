            ...
            <header class="content__header-wrap">
                <div class="content__header">
                    <div class="content__header-item">
                        ...
                        <span class="content__header-description">Thêm thuộc tính cho <?=$productInfo['product_name'];?></span>
                    </div>
                    <div class="content__header-item">
                ...
                <div class="content__home-wrap">
                    <form action="" class="content__form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form__group">
                            ...
                            <div class="form-control">
                                <select name="size">
                                    ...
                                    <option value="S" <?=isset($attribute['size']) && $attribute['size'] == 'S' ? 'selected' : '';?> >Size S</option>
                                    <option value="M" <?=isset($attribute['size']) && $attribute['size'] == 'M' ? 'selected' : '';?> >Size M</option>
                                    <option value="L" <?=isset($attribute['size']) && $attribute['size'] == 'L' ? 'selected' : '';?> >Size L</option>
                                </select>
                        ...
                        <div class="form__group">
                            ...
                            <div class="form-control">
                                <input type="number" name="quantity" placeholder="Nhập số lượng" value="<?=$attribute['quantity'] ?? '';?>">
                                <span class="form-message">
                        ...
                        <div class="form__group">
                            ...
                            <div class="form-control">
                                <input type="number" name="price" placeholder="Nhập đơn giá" value="<?=$attribute['price'] ?? '';?>">
                                <span class="form-message">
                                    <?=$errorMessage['price'] ?? '';?>
                                </span>
                            </div>
                        ...
                        <div class="form__group form__btn-submit">
                            <button type="submit" name="btn_insert">Thêm thuộc tính</button>
                        </div>
                    </form>
                </div>
            </div>
