                ...
                <div class="content__table-wrap">
                    <div class="content__table-heading-wrap">
                        ...
                        <form action="" class="content__table-heading-form" method="POST">
                            <input type="text" class="content__table-heading-form-control form__control-my-booking" name="keyword" placeholder="Nhập tên KH hoặc mã đặt hàng">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        switch($item['status']) {
                                            case 0:
                                                echo '<span class="content__table-stt-active">Chờ xử lý</span>';
                                                break;
                                            case 1:
                                ...
                                <td>
                                    <a href="<?=$ADMIN_URL;?>/account/?booking_detail&id=<?=$item['id'];?>" class="content__table-stt-active">Chi tiết</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
