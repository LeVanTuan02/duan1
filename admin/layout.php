        ...
        <aside class="sidebar">
            ...
            <div class="sidebar__menu-wrapper">
                <ul class="sidebar__menu-nav">
                    ...
                    <li class="sidebar__menu-item">
                        <a href="<?=$ADMIN_URL;?>/binh-luan" class="sidebar__menu-link">
                            <span class="sidebar__menu-icon">
                    ...
                    <li class="sidebar__menu-item">
                        <a href="<?=$ADMIN_URL;?>/thong-ke" class="sidebar__menu-link">
                            <span class="sidebar__menu-icon">
                    ...
                    <li class="sidebar__menu-item">
                        <a href="<?=$ADMIN_URL;?>/thong-ke/?gop_y" class="sidebar__menu-link">
                            <span class="sidebar__menu-icon">
